 ...
 */
final class Version20230704070707 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user_infos (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, fonction VARCHAR(50) DEFAULT NULL, nationality VARCHAR(50) DEFAULT NULL, language VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_C087935A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
