    ...
    <div className="space-y-4">
      ...
      <div className="bg-gray-0 p-8 flex justify-between rounded-xl">
        <div className="flex space-x-4">
          {image ? (
            <img
              className="w-28 h-28 rounded-full border-solid border-2 border-dark"
        ...
        <button onClick={handleImageClick} className="">
          <MenuItem icon={FaPencil} label="Edit" />
        </button>
      </div>
          ...
          <div className="flex justify-between pl-4">
            ...
            <div className="w-1/2 space-y-2">
              ...
              <div>
                ...
                <FormInput name="city" type="text" placeholder="City/State" />
              </div>
              <div>
              ...
              <div>
                ...
                <FormInput name="code" type="text" placeholder="Postal Code" />
              </div>
            </div>
          </div>
        </div>
